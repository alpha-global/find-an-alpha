...
gulp.task( "production:post-build", gulp.series( [ "production:post-build-copy", "production:post-build-cleanup" ] ) );


/**
 * Build theme tasks into one
 */
gulp.task( "theme", gulp.series( [ "theme:styles", "theme:module-styles" ] ) );

gulp.task( 'default', gulp.series( [ 'theme' ] ) );

gulp.task( "watch", function () {
	gulp.watch( paths.watch, gulp.series( [ "theme:styles" ] ) )
	gulp.watch( paths.watch, gulp.series( [ "theme:module-styles" ] ) )
